...
function NurseSignup() {
    return (
        <div>
            ...
            <h2 align='center'>Sign Up as Nurse</h2>
            <Form>
                <Row className='mt-3'>
                ...
                <Form.Group className="mb-3" controlId="formBasicTextareaSkills">
                    <Form.Label>Skills</Form.Label>
                    <Form.Control as="textarea" rows={3} />
                </Form.Group>

                <Form.Group className="mb-3" controlId="formBasicTextareaExpreinces">
                    <Form.Label>Exprences</Form.Label>
                    <Form.Control as="textarea" contentEditable='false' rows={3} />
                </Form.Group>
